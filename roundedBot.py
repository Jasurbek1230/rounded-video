...
tokenAPI='6855027048:AAGyHXSG3u81wRBVyMFX-Zkc3in7FVI5Hpg'
...
async def get_video(message:types.Message):
    ...
    if duration>60:
        await message.answer('Iltimos vidoe davomiyligi 60 sekunddan past bolsin')
    else:
        if file_size>10:
            await message.answer('Video fayl hajmi 10 MB dan kichik bolsin')
        else:
            file=await bot.get_file(file_id=file_id)
            custom_file=f'{file_unique_id}.mp4'
